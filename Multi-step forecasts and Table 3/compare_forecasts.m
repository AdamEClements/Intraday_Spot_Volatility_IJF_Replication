...
formatSpec = '%f %f %f %f';
temp_regfore = readtable('IBM_2_multireg_fore.csv','Format',formatSpec,'ReadVariableNames',true);
...
% GBM forecasts
formatSpec = '%f %f';
temp_gbmfore = readtable('IBM_2_gbm_fore.csv','Format',formatSpec,'ReadVariableNames',true);
fore_gbm = temp_gbmfore.forecast;

% LSTM forecasts
formatSpec = '%f';
temp_lstmfore = readtable('IBM_2_lstm_fore.csv','Format',formatSpec,'ReadVariableNames',true);
