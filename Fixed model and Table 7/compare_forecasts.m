...
% Fixed forecasts
formatSpec = '%f %f';
temp_fix = readtable('IBM_multireg_fore_fix.csv','Format',formatSpec,'ReadVariableNames',true);
fore_fix = temp_fix.fore_multireg_fixed;
...
% All forecasts
forecasts = [fore_reg fore_gbm fore_lstm fore_sHAR fore_fix];
forecasts_names = {'miHAR';'liGBM';'LSTM';'diHAR';'miHAR^F'};
