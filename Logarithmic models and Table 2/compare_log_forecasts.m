...
formatSpec = '%f %f %f %f';
temp_regfore = readtable('IBM_multireg_fore_log.csv','Format',formatSpec,'ReadVariableNames',true);
fore_reg = temp_regfore.fore_multireg;
fore_sHAR = temp_regfore.fore_seasHAR1;

% GBM forecasts
formatSpec = '%f %f';
temp_gbmfore = readtable('IBM_gbm_fore_log.csv','Format',formatSpec,'ReadVariableNames',true);
fore_gbm = temp_gbmfore.forecast;

% LSTM forecasts
formatSpec = '%f %f';
temp_lstmfore = readtable('IBM_lstm_fore_log_test.csv','Format',formatSpec,'ReadVariableNames',true);
